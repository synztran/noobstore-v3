...
export const RaffleGallery = ({ images }: RaffleGalleryProps) => {
	...
	return (
		<section>
			<h3 className="text-2xl font-bold text-white mb-6">🖼️ Gallery</h3>
			<div className="flex gap-6">
				{/* Main Image */}
				<div className="flex-1 relative h-96 rounded-lg overflow-hidden bg-gray-800 group border border-amber-900/30 shadow-lg shadow-black/30">
					<Image
						src={
