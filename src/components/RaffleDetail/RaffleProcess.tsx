	...
	return (
		<section>
			...
			<p className="text-slate-600 mb-8 text-sm leading-relaxed max-w-2xl">
				Từ bước điêu khắc ban đầu đến bước đánh bóng cuối cùng, chứng
				kiến hành quả của bộ series Ether-Glow. Phương pháp đúc hai lần
				đảm bảo lõi nebula được giữ nguyên vẹn trong vẻ nhựa trong suốt.
			</p>
