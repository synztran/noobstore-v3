			...
			<label className="w-full group">
				...
				<span
					className={classNames(
						styles.shadow || "",
						"block max-h-12 max-w-full rounded-lg px-4 py-0 text-gray-600 transition-all delay-150 duration-300 ease-in-out overflow-hidden peer-checked:max-h-max"
					)}
					style={{ backgroundColor: `${bgc}` }}>
					<h3 className="flex h-12 cursor-pointer items-center font-bold w-full justify-between">
						{title}
						<span className="transition-all duration-200 group-has-[:checked]:rotate-90 ">
