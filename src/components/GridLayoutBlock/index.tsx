    ...
    <div className="w-full">
            ...
            <div className="relative w-full h-full min-h-[220px]">
              ...
              <div className="absolute bottom-0 left-0 w-full flex items-center justify-between px-3 py-2 bg-gradient-to-t from-black/70 to-transparent backdrop-blur-[5px]">
                ...
                {item.details ? (
                  <Tooltip
                    placement="left-end"
                    title={<DetailTooltip detail={item.details || {}} />}
                    arrow
                  >
      ...
      <div className="mt-8 flex flex-col items-center justify-center gap-4">
        <div className="flex items-center gap-4">
          ...
          >
            <button className="bg-blue-600 text-white px-6 py-2 rounded-md hover:scale-105 transition-all duration-300 text-lg">
              Follow us
            </button>
          </a>
        </div>
        ...
        <div className="text-black text-xl max-w-lg text-center">
          ...
          <strong className="text-blue-600 text-xl">#noobstore</strong> hoặc{" "}
          <strong className="text-blue-600 text-xl">@noobstore</strong> để có cơ
          hội chia sẻ với mọi người ở đây nhé ♥️
        </div>
      </div>
    </div>
  );
