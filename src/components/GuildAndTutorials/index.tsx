              ...
              <div className="flex flex-col justify-center ml-4 flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <div className="relative w-6 h-6 rounded-full overflow-hidden">
                    <Image
                      src={guide.avatar || NEW_MISSING_IMAGE}
                      alt={guide.author}
                      fill
        ...
        <div className="rounded-xl flex md:flex-row items-center justify-between gap-4 mx-2">
          <div className="max-w-lg">
            ...
            <span className="text-zinc-200 text-sm opacity-80">
              Nhận được các ưu đãi đặc biệt, cập nhật sản phẩm, và thông tin bên
              trong về sản phẩm sắp tới!
            </span>
          </div>
          ...
          >
            <div className="flex items-center bg-[#232323] rounded-md px-2 py-1 w-full max-w-md">
              ...
              <button
                type="submit"
                disabled={!email.trim()}
                className={`ml-2 px-6 py-2 text-xs rounded-md font-semibold text-white bg-[#1769ff] transition-all duration-200 ${
                  email.trim()
