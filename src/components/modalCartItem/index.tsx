  ...
  return (
    ...
    >
      <Box sx={modalStyle}>
        ...
        <div
          className={`${
            cart?.products?.length === 0 ? "justify-center align-middle" : ""
            ...
            <div className="relative flex flex-col items-center justify-center gap-4">
              ...
              <Typography variant="body1" className="text-center">
                ...
                <span className="text-sm text-gray-600">
                  Đã đến lúc tìm và thêm sản phẩm vào giỏ hàng ngay
                </span>
              </Typography>
        ...
        {cart?.products?.length ? (
          <div className="w-full p-2 border-t border-gray-200">
            <span className="text-sm text-gray-600">
              <strong className="text-base">Phí và Giảm giá</strong> sẽ được
              tính toán ở bước tiếp theo
            </span>
            <br />
            <span className="text-sm  text-gray-600">
              Đơn hàng từ{" "}
              <strong className="text-base">{formatCurrency(3000000)}</strong>{" "}
              sẽ được miễn phí vận chuyện nội thành{" "}
              <strong className="text-base">Hồ Chí Mình</strong> từ shop
            </span>
          </div>
        ) : null}
        {cart?.products?.length ? (
        ...
        <>
          ...
          >
            ...
            <div className="col-span-5 flex flex-col justify-between">
              ...
              <Typography className="text-sm" style={{ color: "#656461" }}>
                {item.productName}:&nbsp;
              ...
              <InputQuantity
                ...
                productOptionId={
                  item?.productOptions?.[0]?.productOptionId || ""
                }
              />
            </div>
              ...
              <div className="absolute top-0 right-0">
                {isRemoving ? (
                  ...
                  <IconButton
                    className="p-0.5"
                    onClick={() =>
                      handleRemoveItemCart(item.productId, item.productName)
                    }
                  >
