        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {raffle?.raffleInfo?.paymentMethods?.map((option) => (
                ...
                ${
                  ...
                  >
                    <input
                      ...
                      checked={paymentMethod?.platform === option.platform}
                      onChange={() => {
            ...
            {paymentMethod ? (
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-lg border-2 border-blue-200 p-2 space-y-2">
                <div className="flex items-center gap-2">
                  <Image src={I3D_NOTE} width={40} height={40} alt="note" />
                  <div>
          ...
          <div className={`flex items-center gap-6 justify-around mx-auto`}>
            {donationAmount > 0 ? (
              <div className="text-center">
                <div className=" text-gray-600 mb-1">Ủng hộ Maker</div>
            ...
            <div className="text-center">
              <div className=" text-gray-600 mb-1">Giá sản phẩm</div>
              <div className="text-lg font-bold text-gray-900">
                {formatCurrency(total)}
              </div>
            </div>
            <div className="text-center">
              <div className=" text-gray-600 mb-1">Cần thanh toán</div>
