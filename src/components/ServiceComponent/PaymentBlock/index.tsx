...
const PaymentBlock = ({
  ...
  const isDisabledChange = service?.paymentStatus !== EnumPaymentStatus.PENDING;
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border p-4 space-y-4">
              ...
              <div className="relative" key={option.id}>
                <label
                  className={`w-full h-full
								...
								${
                  (service?.payment?.paymentMethod || paymentMethod?.value) ===
                  option.value
                ...
                >
                  ...
                  />
                  {/* <img
										src={`https://qr.sepay.vn/img?acc=109000663716&bank=ICB&amount=${service.totalPrice}&des=${service.serviceBookingId}`}
									/> */}
                      ...
                      {option?.icon ? (
                        ...
                        >
                          <Image
                            ...
                            draggable={false}
                            style={{
                              transform: `scale(${option.scale || 1})`,
                            }}
                          />
                        </div>
                      ) : null}
                  ...
                  >
                    ...
                    EnumPaymentMethod.BANK_TRANSFER ? (
                      <div className="w-full border-b border-gray-300">
                        ...
                        <div className="relative w-full h-24">
                          <Image
                            src={selectedPaymentMethodOption?.info?.logo || ""}
                            alt="Vietinbank"
                            objectFit="contain"
                            fill
                          />
                    ...
                    <div className="w-full">
                      ...
                      <p className="font-mono bg-gray-200 p-2 rounded font-bold text-blue-600">
                        {selectedPaymentMethodOption?.info?.accountNumber || ""}
                      </p>
                    </div>
                    <div className="w-full">
                      <label className="block font-semibold text-gray-700 mb-1">
                      ...
                      <p className="text-base bg-gray-200 p-2 rounded">
                        {selectedPaymentMethodOption?.info?.accountHolder || ""}
                      </p>
                    </div>
                    <div className="w-full">
                      <label className="block font-semibold text-gray-700 mb-1">
                  ...
                  <div className="flex flex-col w-1/2">
                    ...
                    <div
                      className={`w-full relative overflow-hidden ${
                        selectedPaymentMethodOption?.info?.scale !== 1
                          ? "h-[96%]"
                          : "h-80"
                      }`}
                    >
                      <Image
                        src={
                          selectedPaymentMethodOption?.info?.qrCodeImage || ""
                        }
                        alt="QR Code"
                        objectFit="contain"
                        fill
                    ...
                    <div>
                      ...
                      <ul className="text-yellow-700">
                        <li className="text-sm">
                          • Kiểm tra kĩ thông tin trước chuyển khoản
                        </li>
                        <li className="text-sm">
                          • Vui lòng chuyển khoản đúng số tiền và ghi đúng nội
                          dung
                        </li>
                        <li className="text-sm">
                          • Thanh toán sẽ được xác nhận tự động trong vòng 1-3
                          phút
                        </li>
                        <li className="text-sm">
                          • Liên hệ shop nếu có vấn đề cần hỗ trợ
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div className="relative">
              <label
                className={`block w-full h-full p-4 border-2 rounded-xl cursor-pointer transition-all duration-300 	${
                  selectedPaymentFormOption?.value === option.value
              ...
              >
                <input
                  ...
                  checked={selectedPaymentFormOption?.value === option.value}
                ...
                <div className="text-center mx-auto space-y-2">
                  <div className="w-12 h-12 relative mx-auto">
                    <Image
                      src={option.icon || NEW_MISSING_IMAGE}
                      alt={option.name}
                      fill
                      objectFit="cover"
                      draggable={false}
                  ...
                  <div className="text-green-600 font-semibold text-xl">
                    {formatCurrency(
                      Math.round(total * (option.percentage || 0))
                    )}
                  </div>
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-4 mb-8 border-2 border-green-200">
        ...
        <div className={`flex items-center gap-6 justify-around mx-auto`}>
          ...
          {isPartialPayment ? (
            <div className="text-center">
              <div className=" text-gray-600 mb-1">Thanh toán 1 phần</div>
          ...
          <div className="text-center">
            ...
            <div
              className={`text-lg font-bold ${
                !isPartialPayment ? "text-green-700" : "text-red-400"
              }`}
            >
              {!isPartialPayment
            ...
            <div className="flex items-center justify-center text-white text-xl">
              ...
              {paymentForm && paymentMethod ? (
                <>
                  Thanh toán{" "}
                  {formatCurrency(
                    paymentForm?.value !== EnumPaymentForm.FULL
                      ? amountToPay
                      : fullPay
                  )}
                </>
