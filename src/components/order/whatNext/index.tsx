      ...
      >
        ...
        <Box>
          ...
          <p className="text-gray-600">
            Chúng tôi đã gửi một email đến hộp thư của bạn. Vui lòng kiểm tra
            hộp thư để xem thông tin chi tiết đơn hàng.
          </p>
        </Box>
      </Box>
      <Box
        className="rounded-lg p-4 mt-6 flex gap-4"
        style={{ backgroundColor: "#e9e9e9" }}
      >
        <Box className="bg-white w-12 h-12 flex justify-center items-center rounded-2xl">
        ...
        <Box>
          ...
          <p className="text-gray-600">
            ...
            <a href="#" target="_blank" className="text-red-400 underline">
              Đơn hàng của tôi
            </a>
          </p>
        </Box>
