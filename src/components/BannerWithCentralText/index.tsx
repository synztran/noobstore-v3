...
const desc =
	"Keep your keyboard in top condition with our maintenance and cleaning services. Our experts provide professional and reliable services to ensure that your keyboard is always in optimal condition.";
	...
	return (
        <div className="relative h-96">
            ...
            <div className="flex flex-col justify-center z-10 relative max-w-2xl h-full m-auto items-start">
				...
				<button className="px-4 py-2 bg-blue-500 uppercase text-white font-bold tracking-wider mt-6 rounded-sm hover:scale-105 transition-all ease-in-out duration-300">
					{buttonText}
				</button>
			</div>
        </div>
