...
export function CustomStyledDialogExample() {
	return (
		<Dialog>
			...
			<DialogPortal>
				<DialogContent className="bg-linear-to-br from-blue-50 to-indigo-100 border-blue-200">
					<DialogHeader>
						<DialogTitle className="text-2xl text-blue-900">
							Custom Styled Dialog
						</DialogTitle>
						<DialogDescription className="text-blue-700">
							This dialog has custom styling with gradients,
							larger size, and rounded corners.
						</DialogDescription>
					</DialogHeader>
					<div className="py-6">
