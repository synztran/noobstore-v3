...
const RaffleSettingsSection: React.FC<ISectionProps> = ({
	...
	const secretKeyField = useDebouncedField(
		"secretKey",
		values.secretKey || "",
		setFieldValue,
	);
		...
		<div className="space-y-6">
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<TextField
					...
					onBlur={handleBlur}
					error={
						touched.totalEntriesMax &&
						Boolean(errors.totalEntriesMax)
					}
					helperText={
						touched.totalEntriesMax && errors.totalEntriesMax
					}
				/>
				...
				<TextField
					...
					onBlur={handleBlur}
					error={
						touched.maxWinPerEntries &&
						Boolean(errors.maxWinPerEntries)
					}
					helperText={
						touched.maxWinPerEntries && errors.maxWinPerEntries
					}
				/>
			...
			<div className="border-t pt-6 mt-6 space-y-2">
				...
				{values.isHaveSecretKey && (
					<TextField
						...
						onChange={secretKeyField.onChange}
						onBlur={handleBlur}
