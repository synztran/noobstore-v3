		...
		<div className="relative">
			<div className="text-center mb-6 flex flex-col gap-2 items-center">
				...
				<div className="text-gray-600">
					Đảm bảo bạn đã có khóa bảo mật, nếu chưa hãy tham gia vào
					cộng động của maker.
				</div>
			</div>
			...
			{raffleSubmitForm?.secretKey ? (
				<div className="p-4 rounded-lg bg-green-100 border border-green-400 text-green-800 text-center">
					...
					<strong className="text-green-800">thành công!</strong> Mời
					bạn tiếp tục
				</div>
			) : (
				<div className="p-4 rounded-lg bg-gray-200 border">
					<form
						...
						<div className="relative space-y-2">
							...
							<div
								className={`text-sm ${message ? "text-red-400" : "text-gray-600"} absolute -bottom-6`}>
								{message || ""}
							</div>
						</div>
