...
const StepperRaffleFooter = ({
	...
	const handleSubmitRaffle = async () => {
		...
		if (resp.status === "OK") {
			...
			NotifyUtils.error(resp.message);
		}
	};
	...
	return (
		<div
			className={`p-4 block bottom-0 w-full bg-white border-t-2 border-gray-300 ${footerProperties.classNames || ""}`}>
