		...
		<div className="container max-w-7xl mx-auto py-4 !px-0">
			<div className="grid grid-cols-1 md:grid-cols-12 gap-4">
				...
				<div className="col-span-7 flex flex-col items-center justify-center h-full relative max-h-max gap-4">
					...
					<div className="w-full h-full rounded-xl shadow-md bg-white p-4 flex gap-4">
						<div className="flex items-center gap-3 mt-2 w-5/12">
							<div className="w-20 h-20 bg-gray-200 rounded-full relative overflow-hidden border border-gray-600">
								<Image
									src={
