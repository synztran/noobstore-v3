...
const SummaryServiceBlock = (props: Props) => {
	...
	console.log("keyboardItems service block", keyboardItems, switchItems);

	return (
		<div className="flex items-start gap-2">
			<Package size={28} className="min-w-[28px]" />
								...
								<div className="flex items-start gap-1">
									...
									<div className="flex flex-col w-full">
										<div className="flex flex-col">
											<span className="text-base font-medium min-h-[24px]">
												{keyboard.keyboardName}
											</span>
											<div className="flex gap-1 min-h-[22px]">
												<span className="border border-gray-700 rounded-md p-1 leading-[1] text-xs text-gray-700">
													{keyboard.pcbType || "N/A"}
												</span>
												<span className="border border-gray-700 rounded-md p-1 leading-[1] text-xs text-gray-700">
								...
								<div className="flex items-start gap-1">
									...
									<div className="flex flex-col w-full">
										...
										<div className="flex flex-col">
											...
											{sw.services.quickClean?.isUse &&
											sw.services.quickClean?.price ? (
												<div className="flex items-center justify-between w-full">
													<span className="text-base">
														Vệ sinh re-lube
													</span>
