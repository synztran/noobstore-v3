...
export const appQueryKeys = mergeQueryKeys(cartQueryKeys, userQueryKeys, categoryQueryKeys, productQueryKeys, configQueryKeys, orderQueryKeys, serviceQueryKeys, raffleQueryKeys, makerQueryKeys)
