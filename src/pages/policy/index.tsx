      ...
      <Container maxWidth="lg" className="py-8">
        ...
        <Card className="mb-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <CardContent className="text-center py-8">
            ...
            <Typography variant="h6" className="opacity-100 text-gray-200">
              Quy định và chính sách toàn diện cho sản phẩm, dịch vụ và hoạt
              động trung gian
            </Typography>
            <div className="flex flex-wrap justify-center gap-2 mt-4">
              <Chip label="Sản phẩm" className="bg-white text-blue-600" />
              <Chip label="Dịch vụ" className="bg-white text-blue-600" />
              <Chip label="Giao hàng" className="bg-white text-blue-600" />
              <Chip label="Trung gian" className="bg-white text-blue-600" />
            </div>
          </CardContent>
        </Card>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center">
                    ...
                    <Typography>tháng cho bàn phím</Typography>
                  </div>
                  <div className="text-center">
                    <Typography
                      variant="h4"
                    ...
                    <Typography>tháng cho switch</Typography>
                  </div>
                  <div className="text-center">
                    <Typography
                      variant="h4"
                    ...
                    <Typography>tháng cho keycap</Typography>
                  </div>
                </div>
              </div>
            </PolicySubSection>
            ...
            <PolicySubSection title="2. Quy Trình Nhận Dịch Vụ">
              <div className="flex flex-col md:flex-row gap-4">
                {[
                  ...
                  <Card key={item.step} className="flex-1 text-center">
                    <CardContent>
            ...
            <PolicySubSection title="3. Trách Nhiệm Dịch Vụ">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Card className="border-l-4 border-orange-500">
                  <CardContent>
                    <Typography variant="h6" className="text-orange-600 mb-3">
                    ...
                    <CardContent>
                      ...
                      <div className="flex justify-between items-center mb-2">
                        <Chip
                          ...
                          label={method.price}
                          color={
                            method.price === "Miễn phí" ? "success" : "primary"
                          }
                          size="small"
                        />
                        <Typography variant="body2" className="text-gray-600">
            ...
            <PolicySubSection title="2. Khu Vực Phục Vụ">
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <Typography className="mb-3">
                  TP. Hồ Chí Minh và các quận/huyện lân cận. Phí giao hàng theo
                  bảng giá chuẩn.
                </Typography>
                <Typography variant="h6" className="text-orange-600 mb-3">
                ...
                <Typography>
                  Có thể phục vụ với phí phụ trội và thời gian giao hàng lâu
                  hơn. Liên hệ để được tư vấn cụ thể.
                </Typography>
              </div>
            </PolicySubSection>
          ...
          <div className="space-y-6">
            <PolicySubSection title="1. Dịch Vụ Trung Gian Mua Hàng">
              <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-lg mb-4">
                ...
                <Typography>
                  NoobStore hỗ trợ khách hàng mua sản phẩm từ các nguồn khác
                  (nước ngoài, các shop khác) khi sản phẩm không có sẵn hoặc có
                  giá tốt hơn.
                </Typography>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Card className="text-center">
                  <CardContent>
                    ...
                    <Typography variant="body2" className="text-gray-600">
                      Tính trên giá trị đơn hàng (tối thiểu 100,000đ)
                    </Typography>
                  </CardContent>
                </Card>
                <Card className="text-center">
                  <CardContent>
                    ...
                    <Typography variant="body2" className="text-gray-600">
                      Tùy theo nguồn hàng và phương thức vận chuyển
                    </Typography>
                  </CardContent>
                </Card>
                <Card className="text-center">
                  <CardContent>
                    ...
                    <Typography variant="body2" className="text-gray-600">
                      Hoàn tiền nếu không thể mua được hàng
                    </Typography>
                  </CardContent>
                </Card>
              </div>
            ...
            <PolicySubSection title="3. Điều Khoản Đặc Biệt">
              <div className="grid md:grid-cols-2 gap-4">
                <Card className="border-l-4 border-red-500">
                  <CardContent>
                    <Typography variant="h6" className="text-red-600 mb-3">
                      ⚠️ Rủi ro & Giới hạn
                    </Typography>
                    <List dense>
                      <ListItem>
          ...
          <div className="space-y-6">
            <PolicySubSection title="1. Quyền và Nghĩa vụ">
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <Typography variant="body1" className="mb-3 mt-4">
            ...
            <PolicySubSection title="2. Giải Quyết Tranh Chấp">
              <Typography className="mb-3">
                Mọi tranh chấp sẽ được giải quyết theo thứ tự ưu tiên:
              </Typography>
              <div className="space-y-2">
                <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                  ...
                  <Typography>
                    Thương lượng trực tiếp giữa NoobStore và khách hàng
                  </Typography>
                </div>
                <div className="flex items-center gap-3 p-3 bg-yellow-50 rounded-lg">
                  ...
                  <Typography>Hòa giải qua bên thứ ba (nếu cần)</Typography>
                </div>
                <div className="flex items-center gap-3 p-3 bg-red-50 rounded-lg">
                  <div className="w-8 h-8 bg-red-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
                    3
                  </div>
                  <Typography>Giải quyết theo pháp luật Việt Nam</Typography>
                </div>
              </div>
            </PolicySubSection>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="space-y-2">
                        <Typography>• Hotline: 1900 xxxx</Typography>
                        <Typography>• Email: support@noobstore.com</Typography>
                        <Typography>• Địa chỉ: [Địa chỉ cửa hàng]</Typography>
                        <Typography>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <Typography>• Live chat trên website</Typography>
                        <Typography>• Facebook Messenger</Typography>
                        <Typography>• Zalo OA</Typography>
        ...
        <Card className="mt-8 bg-gray-100">
          <CardContent className="text-center">
            <Typography variant="body2" className="text-gray-600">
              Chính sách này có hiệu lực từ ngày {effectiveDate || ""} và có thể
              được cập nhật theo thời gian.
              <br />
              Phiên bản mới nhất luôn được đăng tải tại noobstore.com/policy
            </Typography>
          </CardContent>
        </Card>
      </Container>
