...
const ServiceInfoPage = (): React.ReactElement => {
	...
	const renderServiceHeader = (): React.ReactElement => <ServiceHeader />;

	const renderServiceStatus = (): React.ReactElement => {
		const status =
	...
	const renderPaymentInstructions = (): React.ReactElement | null => {
