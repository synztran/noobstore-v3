...
const ServiceInfoPage = (): JSX.Element => {
  ...
  const renderServiceStatus = (): JSX.Element => {
    ...
    const statusInfo = SERVICE_STATUS_MAP[status] || SERVICE_STATUS_MAP.CREATED;
    ...
    return (
      <div className="bg-white rounded-xl shadow-lg border p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="text-2xl mb-2">⏰</div>
            <div className="text-sm text-gray-600">Thời gian cập nhật</div>
            <div className="font-semibold">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="font-semibold">{service?.contact?.name}</div>
          </div>
        </div>
      </div>
    );
      ...
      <div className="bg-white rounded-xl shadow-lg border p-6 mb-6">
        ...
        <div className="relative mb-8">
          ...
          <div
            ...
            style={{
              width: `${
                (currentStepIndex / (SERVICE_STEPS.length - 1)) * 100
              }%`,
            }}
          ></div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-yellow-700 text-sm mt-1 space-y-1">
                  <li>
                    • Vui lòng chuyển khoản đúng số tiền và ghi đúng nội dung
                  </li>
                  <li>
                    • Thanh toán sẽ được xác nhận tự động trong vòng 5-10 phút
                  </li>
    ...
    return (
      <Base>
        <div className="flex flex-col items-center justify-center h-full py-20">
          ...
          <h2 className="text-2xl font-bold mb-2">Dịch vụ không tồn tại</h2>
          <p className="text-gray-600">
            Không tìm thấy dịch vụ với ID đã cung cấp. Vui lòng kiểm tra lại
            liên kết hoặc quay lại trang chủ.
          </p>
