import { DEFAULT_NOOBSTORE_DESCRIPTION, DEFAULT_NOOBSTORE_LONG_TITLE, DEFAULT_NOOBSTORE_TITLE } from '@/constants/data'
...
const MyApp = ({ Component, pageProps }: AppPropsWithLayout) => {
  ...
  const Layout = Component.layout || (({ children }: { children: React.ReactElement }) => children)
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={DEFAULT_NOOBSTORE_DESCRIPTION} />
        ...
        <meta property="og:description" content={DEFAULT_NOOBSTORE_DESCRIPTION} />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0" />
      </Head>
      <ThemeProvider>
        <ContextProviderCompose contextProviders={[<QueryClientProvider key="QueryClientProvider" client={queryClient} />, <AuthProvider key="authProvider" token={token as string} redirectUrl={redirectUrl as string} initUser={user} source={source as string} children={undefined} />]}>
