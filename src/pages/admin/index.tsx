...
import Footer from "@/adminComponents/Footers/Footer";
import IndexNavbar from "@/adminComponents/Navbars/IndexNavbar";
...
export default function Index() {
	...
	if (!isLoading)
		return (
			<div className="w-screen h-screen bg-[#28254c]">
				<NotFoundPage />
			</div>
		);
		...
		<div>
			...
			<section className="header relative pt-16 items-center flex h-screen max-h-860-px">
					...
					<div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
						<div className="pt-32 sm:pt-0">
							<h2 className="font-semibold text-4xl text-slate-600">
								Notus NextJS - A beautiful extension for
								Tailwind CSS.
							</h2>
							<p className="mt-4 text-lg leading-relaxed text-slate-500">
								Notus NextJS is Free and Open Source. It does
								not change any of the CSS from{" "}
								<a
				...
				<img
					...
					src="/admin/image/pattern_nextjs.png"
					alt="..."
				/>
			</section>
				...
				<div className="container mx-auto">
					<div className="flex flex-wrap items-center">
						<div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
							<div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg hover:bg-slate-700">
								<img
									alt="..."
								...
								<blockquote className="relative p-8 mb-4">
									<svg
										...
										<polygon
											...
											className="text-slate-700 fill-current"></polygon>
									</svg>
									...
									<div className="relative flex flex-col mt-4">
										<div className="px-4 py-5 flex-auto">
											...
											<p className="mb-4 text-slate-500">
												Notus NextJS comes with a huge
					...
					<div className="flex flex-wrap items-center">
						...
						<div className="w-full md:w-5/12 px-4 mr-auto ml-auto mt-32">
							<div className="relative flex flex-col min-w-0 w-full mb-6 mt-48 md:mt-0">
								<img
									alt="..."
									src="/admin/image/component-btn.png"
									className="w-full align-middle rounded absolute shadow-lg max-w-100-px left-145-px -top-29-px z-3"
								/>
								<img
									alt="..."
									src="/admin/image/component-profile-card.png"
									className="w-full align-middle rounded-lg absolute shadow-lg max-w-210-px left-260-px -top-160-px"
								/>
								<img
									alt="..."
									src="/admin/image/component-info-card.png"
									className="w-full align-middle rounded-lg absolute shadow-lg max-w-180-px left-40-px -top-225-px z-2"
								/>
								<img
									alt="..."
									src="/admin/image/component-info-2.png"
									className="w-full align-middle rounded-lg absolute shadow-2xl max-w-200-px -left-50-px top-25-px"
								/>
								<img
									alt="..."
									src="/admin/image/component-menu.png"
									className="w-full align-middle rounded absolute shadow-lg max-w-580-px -left-20-px top-210-px"
								/>
								<img
									alt="..."
									src="/admin/image/component-btn-pink.png"
					...
					<div className="items-center flex flex-wrap">
						...
						<div className="w-full md:w-6/12 mr-auto px-4 pt-24 md:pt-0">
							<img
								...
								src="/admin/image/documentation.png"
							/>
						</div>
					</div>
				</div>
				...
				<div className="justify-center text-center flex flex-wrap mt-24">
					<div className="w-full md:w-6/12 px-12 md:px-4">
						...
						<p className="text-lg leading-relaxed mt-4 mb-4 text-slate-500">
							Notus NextJS is a completly new product built using
