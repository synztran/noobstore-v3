			...
			<div className="container py-4 mx-auto max-w-full border-t border-gray-400 h-full">
				<div className="grid grid-cols-7 gap-8">
					<div className="col-span-3">
						...
						<span className="text-gray-800 text-base">
							Được thông báo về sản phẩm mới, sản phẩm quan tâm và
						...
						<form
							...
							<div className="relative w-full mt-4">
								<input
									id="email"
									type="email"
									className="px-0 py-2 text-gray-700 bg-transparent border-t-0 border-x-0 border-b border-gray-600 focus:border-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300 w-full"
					...
					<div className="col-span-2">
						...
						<div className="flex flex-col items-start gap-2 text-gray-600 ">
							...
							<Link
								...
								70/4b Đường 47 Hiệp Bình Chánh Thủ Đức, TP. Hồ
								Chí minh
							</Link>
						</div>
					</div>
				...
				<div className="flex items-center justify-center mt-4 w-full">
					<div className="flex text-sm flex-wrap align-middle items-center">
						...
						<div className="w-full flex justify-center uppercase text-sm font-bold">
							© NoobStore® 2025.
						</div>
