...
import { EnumPaymentMethod, EnumRafflePaymentStepStatus, EnumRafflePaymentStepType, IImage } from '../interface'
...
export type TPayloadSubmitOrderPayment = {
  orderId: string
  paymentAttachment?: IImage
}
